...
| **M8** (mixed corpus: MBPP 374 + synthetic 1471) | same-vocab on-policy FKL | **53.0** HE / 51.7 MBPP partial | HE −6.8 vs base, **identical to M6b ⇒ CTD parity proof** (cross-vocab projection is not the limit, the recipe family is) |
